...
if (rs.next()) {
	out.println("You have Already reported this item. Please be patient till out staff can verify and take action");
    }
else {%>
	REPORT ITEM
	<form action="addtoreport.jsp" method="POST">
	Item ID:<input type="text" name="item_name"  value=<%=item_id%> readonly> <br/>
	Please describe the reason for reporting :<br/>
	<textarea name="reason" rows="4" cols="50">Report Description here</textarea><br/>
